  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <g opacity=".7"><rect width="182.77" height="162" x="682.04" y="387" fill="url(#894cb520-7283-4f65-92a7-edb841614828)" rx="21.34" ry="21.34" /></g>
        <rect width="176" height="156" x="685.42" y="390" fill="#e0e0e0" rx="21.34" ry="21.34" />
        <image width="174" height="153" x="682.04" y="387" rx="21.34" ry="21.34" href={azure} />
      </svg>
    );
  }
}
